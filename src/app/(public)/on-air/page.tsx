...
export default async function OnAirPage({
  ...
  const { data: shows } = await supabase
    .from("cms_shows")
    .select("id, title, slug, tagline, show_type, logo_path, banner_path, broadcast_status, cms_show_hosts(name, is_primary), cms_show_tags(tag_id, cms_tags(id, name, slug, category))")
    .eq("is_active", true)
    .is("deleted_at", null)
