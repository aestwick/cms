...
const PLATFORM_PATTERNS: [RegExp, string][] = [
  ...
  [/iheart\.com|iheartr/i, "iheartradio"],
  [/tunein\.com/i, "tunein"],
  [/mixcloud\.com/i, "mixcloud"],
  [/pocketcasts\.com/i, "pocketcasts"],
  [/music\.amazon\.|amazon\.com\/music|audible\.com/i, "amazon_music"],
  [/stitcher\.com/i, "stitcher"],
  [/deezer\.com/i, "deezer"],
  [/whatsapp\.com|wa\.me/i, "whatsapp"],
  [/signal\.org|signal\.group/i, "signal"],
  [/pinterest\.com|pin\.it/i, "pinterest"],
  [/vimeo\.com/i, "vimeo"],
  [/ko-fi\.com/i, "kofi"],
  [/linktr\.ee|linktree\.com/i, "linktree"],
  [/paypal\.com|paypal\.me/i, "paypal"],
  [/venmo\.com/i, "venmo"],
  [/cash\.app/i, "cashapp"],
