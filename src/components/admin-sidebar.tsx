...
export function AdminSidebar({ role }: { role: CmsRole }) {
  ...
  return (
    <aside className="flex w-56 flex-col border-r border-charcoal/20 bg-charcoal text-off-white">
      <div className="border-b border-off-white/10 px-4 py-4">
        <Link href="/admin" className="block">
          <span className="text-lg font-bold tracking-tight">KPFK</span>
          <span className="ml-1.5 text-xs font-mono text-off-white/50">CMS</span>
        </Link>
      </div>
